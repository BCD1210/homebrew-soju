class Soju < Formula
  ...
  url "https://github.com/BCD1210/soju/archive/refs/tags/v1.6.2.tar.gz"
  sha256 "0b480f6b9dc40ecdf30a12fc469778b5c9685029491a9874d6d1807e9c7ca675"
  ...
  test do
    assert_match "1.6.2", shell_output("#{bin}/soju --version")
