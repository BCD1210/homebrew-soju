class Soju < Formula
  ...
  url "https://github.com/BCD1210/soju/archive/refs/tags/v1.6.1.tar.gz"
  sha256 "5a0ce3fffd664bcc5e1c2e03c4e9c33b33784d2301de9e1160ae6fb2255c82c9"
  ...
  test do
    assert_match "1.6.1", shell_output("#{bin}/soju --version")
